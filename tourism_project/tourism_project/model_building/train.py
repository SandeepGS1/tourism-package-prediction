...
MODEL_REPO_ID = "SandeepGS/tourism-package-prediction"
...
with mlflow.start_run(run_name="xgboost_fast_ci_search"):
    ...
    # NOTE:
    # sklearn Pipeline + early stopping through fit params can be clumsy
    # so we keep the search lean instead of overcomplicating the flow.
    ...
    # Save full search results once, instead of nested MLflow runs
