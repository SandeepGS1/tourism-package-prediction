...
Xtrain_local = hf_hub_download(
    repo_id=DATASET_REPO_ID, repo_type="dataset", filename="Xtrain.csv", token=HF_TOKEN
)
Xtest_local = hf_hub_download(
    repo_id=DATASET_REPO_ID, repo_type="dataset", filename="Xtest.csv", token=HF_TOKEN
)
ytrain_local = hf_hub_download(
    repo_id=DATASET_REPO_ID, repo_type="dataset", filename="ytrain.csv", token=HF_TOKEN
)
ytest_local = hf_hub_download(
    repo_id=DATASET_REPO_ID, repo_type="dataset", filename="ytest.csv", token=HF_TOKEN
)

Xtrain = pd.read_csv(Xtrain_local)
Xtest = pd.read_csv(Xtest_local)
ytrain = pd.read_csv(ytrain_local).squeeze("columns")
ytest = pd.read_csv(ytest_local).squeeze("columns")
